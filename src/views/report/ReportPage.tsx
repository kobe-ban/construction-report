    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8 text-center">
        ...
        <div className="flex gap-3 w-full max-w-xs">
          <Button variant="secondary" fullWidth onClick={() => router.push(`/bridge/${bridgeId}`)}>
            ดูไทม์ไลน์
          </Button>
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="shrink-0 bg-white border-b border-gray-200 z-40 px-4 py-3">
        <div className="flex items-center gap-3 mb-3">
          <button onClick={() => wizardStep > 0 ? setWizardStep(wizardStep - 1) : router.back()} className="p-1 -ml-1 text-gray-600">
            <ArrowLeft size={22} />
          </button>
